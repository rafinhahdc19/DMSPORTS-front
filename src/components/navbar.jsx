        ...
        <div className="justify-between py-3 md:py-0 px-1  mx-auto w-full lg:max-w-7xl md:items-center md:flex md:px-1">
          ...
          >
            <ul className="h-screen md:h-auto items-center justify-center md:flex ">
              <li className="pb-3 mb-3 text-base text-black py-3 px-6 text-center  border-b-2 md:border-b-0  focus:bg-gray-200 rounded-sm   border-black   md:hover:bg-transparent">
